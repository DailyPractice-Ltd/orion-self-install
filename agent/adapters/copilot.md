...
4. **Actions/plugins**: only the connectors the checklist names (CRM read-and-write, email read-and-draft,
   calendar read). The approval gate is the agent's own rules — drafts only; sending
